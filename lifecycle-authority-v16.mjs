...
const DEFINITIONS=Object.freeze({
  ORDER:Object.freeze({
    initial:'AWAITING_PAYMENT_CONNECTOR',terminal:Object.freeze(['CANCELLED','OWNERSHIP_TRANSFERRED']),transitions:Object.freeze([
      ...
      rule('CONFIRM_OWNERSHIP','PAID','OWNERSHIP_TRANSFERRED',['BUYER','SYSTEM'],{preconditions:['RECEIPT_CONFIRMED'],auditAction:'ORDER_OWNERSHIP_TRANSFERRED',outboxTopic:'ORDER.OWNERSHIP_TRANSFERRED'}),
  ...
  SHIPMENT:Object.freeze({
    initial:'QUOTE_REQUIRED',terminal:Object.freeze(['DELIVERED','CANCELLED']),transitions:Object.freeze([
      rule('QUOTE','QUOTE_REQUIRED','QUOTED',['BUYER','SELLER','OPERATOR','SYSTEM'],{preconditions:['QUOTE_AVAILABLE'],outboxTopic:'SHIPMENT.QUOTED'}),
      rule('BOOK','QUOTED','BOOKED',['SELLER','OPERATOR','PROVIDER','SYSTEM']),
      rule('PACK','BOOKED','PACKING',['SELLER','OPERATOR','PROVIDER','SYSTEM']),
      rule('DISPATCH',['PACKING','DELIVERY_FAILED'],'IN_TRANSIT',['SELLER','PROVIDER','OPERATOR','SYSTEM'],{preconditions:['PROVIDER_EVENT_OR_PREVIEW'],outboxTopic:'SHIPMENT.IN_TRANSIT'}),
      rule('MARK_COLLECTION_READY','PACKING','COLLECTION_READY',['SELLER','OPERATOR','SYSTEM']),
      rule('DELIVER',['IN_TRANSIT','COLLECTION_READY','DAMAGE_REPORTED'],'DELIVERED',['SELLER','PROVIDER','OPERATOR','SYSTEM'],{preconditions:['PROVIDER_EVENT_OR_PREVIEW'],outboxTopic:'SHIPMENT.DELIVERED'}),
      rule('DELIVERY_FAILED','IN_TRANSIT','DELIVERY_FAILED',['SELLER','PROVIDER','OPERATOR','SYSTEM'],{preconditions:['PROVIDER_EVENT_OR_PREVIEW']}),
      rule('REPORT_DAMAGE','IN_TRANSIT','DAMAGE_REPORTED',['SELLER','PROVIDER','OPERATOR','SYSTEM'],{preconditions:['PROVIDER_EVENT_OR_PREVIEW'],outboxTopic:'SHIPMENT.DAMAGE_REPORTED'}),
      rule('CANCEL',['QUOTE_REQUIRED','QUOTED','BOOKED','PACKING','COLLECTION_READY','DELIVERY_FAILED'],'CANCELLED',['SELLER','OPERATOR','PROVIDER','SYSTEM'])
    ])
  }),
  PAYOUT:Object.freeze({
    initial:'ON_HOLD',terminal:Object.freeze(['PAID','REVERSED']),transitions:Object.freeze([
      ...
      rule('SUBMIT','READY','SUBMITTED',['PROVIDER','OPERATOR','SYSTEM'],{preconditions:['PROVIDER_EVENT_OR_PREVIEW'],outboxTopic:'PAYOUT.SUBMITTED'}),
      rule('MARK_PAID','SUBMITTED','PAID',['PROVIDER','OPERATOR','SYSTEM'],{preconditions:['PROVIDER_EVENT_OR_PREVIEW'],outboxTopic:'PAYOUT.PAID'}),
      rule('MARK_FAILED','SUBMITTED','FAILED',['PROVIDER','OPERATOR','SYSTEM'],{preconditions:['PROVIDER_EVENT_OR_PREVIEW'],outboxTopic:'PAYOUT.FAILED'}),
  ...
  DISPUTE:Object.freeze({
    initial:'OPEN',terminal:Object.freeze(['RESOLVED_BUYER','RESOLVED_SELLER','PARTIAL_REFUND','FULL_REFUND','CLOSED']),transitions:Object.freeze([
      ...
      rule('CONTINUE_REVIEW','UNDER_REVIEW','UNDER_REVIEW',['OPERATOR','SYSTEM']),
  ...
  VERIFICATION:Object.freeze({
    initial:'PENDING',terminal:Object.freeze([]),transitions:Object.freeze([
      ...
      rule('REFRESH_REVIEW','IN_PROGRESS','IN_PROGRESS',['PROVIDER','OPERATOR','SYSTEM'],{preconditions:['DECISION_SOURCE_VERIFIED']}),
      ...
      rule('REFRESH_MORE_INFO','MORE_INFO_REQUIRED','MORE_INFO_REQUIRED',['PROVIDER','OPERATOR','SYSTEM'],{preconditions:['DECISION_SOURCE_VERIFIED']}),
      ...
      rule('RESUBMIT',['REJECTED','EXPIRED'],'PENDING',['BUYER','SELLER'],{outboxTopic:'VERIFICATION.PENDING'}),
      ...
      rule('REFRESH_VERIFIED','VERIFIED','VERIFIED',['PROVIDER','OPERATOR','SYSTEM'],{preconditions:['DECISION_SOURCE_VERIFIED']}),
      ...
      rule('REFRESH_REJECTED','REJECTED','REJECTED',['PROVIDER','SYSTEM'],{preconditions:['DECISION_SOURCE_VERIFIED']}),
      ...
      rule('REFRESH_EXPIRED','EXPIRED','EXPIRED',['PROVIDER','SYSTEM'],{preconditions:['DECISION_SOURCE_VERIFIED']})
    ])
  }),
  PUBLICATION:Object.freeze({
    initial:'DRAFT',terminal:Object.freeze(['PUBLISHED']),transitions:Object.freeze([
      ...
      rule('REQUEST_CHANGES',['CATALOGUE_REVIEW','APPROVED'],'CHANGES_REQUESTED',['OPERATOR'],{outboxTopic:'PUBLICATION.CHANGES_REQUESTED'}),
      rule('APPROVE','CATALOGUE_REVIEW','APPROVED',['OPERATOR'],{preconditions:['CHECKLIST_READY'],outboxTopic:'PUBLICATION.APPROVED'}),
      rule('PUBLISH','APPROVED','PUBLISHED',['OPERATOR'],{preconditions:['CHECKLIST_READY','CATALOGUE_APPROVED','TRUST_ALLOWED','SELLER_VERIFIED','NO_BLOCKING_RISK'],outboxTopic:'PUBLICATION.PUBLISHED'})
    ])
  }),
  MEDIA:Object.freeze({
    initial:'UPLOADING',terminal:Object.freeze(['READY','REJECTED','ARCHIVED']),transitions:Object.freeze([
      ...
      rule('RETRY_VERIFY','VERIFYING','VERIFYING',['SELLER','OPERATOR','SYSTEM']),

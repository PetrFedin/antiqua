...
await walk('main.js');
const expected=['main.js','app.js','operations.js','modules/core.js','modules/discovery.js','modules/collection.js','modules/transactions.js','modules/cockpit.js','modules/seller-analytics.js','modules/engagement.js','modules/similarity.js','modules/auction-results.js','modules/inquiry.js','modules/offers.js','modules/services.js','modules/dealer-leads.js','modules/market-intelligence.js','modules/culture-discovery.js'].sort();
...
assert.match(css,/v16-cockpit/);assert.match(css,/v20-public-auction-results/);assert.match(css,/auction-result-card-v20/);assert.match(css,/v21-object-inquiry/);assert.match(css,/inquiry-context-v21/);assert.match(css,/v22-offer-negotiation/);assert.match(css,/v23-condition-viewing/);assert.match(css,/v24-dealer-lead-cockpit/);assert.match(css,/v25-market-intelligence/);assert.match(css,/v0\.26 · Culture of Objects/);
console.log('ANTIQUA v26 frontend consolidation: canonical module graph + commercial cycle + Market Intelligence surface + preserved cascade passed');

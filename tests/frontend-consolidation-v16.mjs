...
assert.match(css,/v16-cockpit/);assert.match(css,/v20-public-auction-results/);assert.match(css,/auction-result-card-v20/);assert.match(css,/v21-object-inquiry/);assert.match(css,/inquiry-context-v21/);assert.match(css,/v22-offer-negotiation/);assert.match(css,/v23-condition-viewing/);
console.log('ANTIQUA v23 frontend consolidation: canonical module graph + inquiry + negotiation + services surfaces + preserved cascade passed');

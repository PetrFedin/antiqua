...
for(const p of ['index.html','styles.css','main.js','app.js','operations.js','modules/core.js','modules/discovery.js','modules/collection.js','modules/transactions.js','modules/cockpit.js','modules/seller-analytics.js','modules/engagement.js','modules/similarity.js','modules/auction-results.js'])assert.ok(publicFiles.includes(p),'canonical frontend asset missing: '+p);
...
await walk('main.js');
const expected=['main.js','app.js','operations.js','modules/core.js','modules/discovery.js','modules/collection.js','modules/transactions.js','modules/cockpit.js','modules/seller-analytics.js','modules/engagement.js','modules/similarity.js','modules/auction-results.js'].sort();
...
assert.match(css,/v16-cockpit/);assert.match(css,/v20-public-auction-results/);assert.match(css,/auction-result-card-v20/);
console.log('ANTIQUA v20 frontend consolidation: canonical module graph + auction result CSS + preserved cascade passed');

...
assert.match(css,/v16-cockpit/);assert.match(css,/v20-public-auction-results/);assert.match(css,/auction-result-card-v20/);assert.match(css,/v21-object-inquiry/);assert.match(css,/inquiry-context-v21/);
console.log('ANTIQUA v21 frontend consolidation: canonical module graph + inquiry surface + preserved cascade passed');

...
for(const p of ['index.html','styles.css','main.js','app.js','operations.js','modules/core.js','modules/discovery.js','modules/collection.js','modules/transactions.js','modules/cockpit.js','modules/seller-analytics.js','modules/engagement.js','modules/similarity.js'])assert.ok(publicFiles.includes(p),'canonical frontend asset missing: '+p);
...
await walk('main.js');
const expected=['main.js','app.js','operations.js','modules/core.js','modules/discovery.js','modules/collection.js','modules/transactions.js','modules/cockpit.js','modules/seller-analytics.js','modules/engagement.js','modules/similarity.js'].sort();

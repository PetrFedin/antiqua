...
assert.match(css,/v16-cockpit/);assert.match(css,/v20-public-auction-results/);assert.match(css,/auction-result-card-v20/);assert.match(css,/v21-object-inquiry/);assert.match(css,/inquiry-context-v21/);assert.match(css,/v22-offer-negotiation/);assert.match(css,/v23-condition-viewing/);assert.match(css,/v24-dealer-lead-cockpit/);
console.log('ANTIQUA v24 frontend consolidation: canonical module graph + inquiry + negotiation + services + Dealer Inbox surfaces + preserved cascade passed');

...
const worker=await readFile(new URL('../worker-runtime-v15.mjs',import.meta.url),'utf8');
...
assert.match(worker,/watchNotificationDelivery:'TRANSACTIONAL_EXACTLY_ONCE_INTERNAL'/,'worker capability must disclose WATCH exact-once internal delivery');

...
try{
 ...
 const homeR=await fetch(base),home=await homeR.text();assert.match(home,/styles-v12\.css/);assert.match(home,/experience-v12\.js/);assert.match(home,/ANTIQUA · 0\.12/);assert.match(homeR.headers.get('content-security-policy')||'',/style-src[^;]*unsafe-inline/);

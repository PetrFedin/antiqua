...
{
  denied({domain:'SHIPMENT',from:'PACKING',to:'IN_TRANSIT',action:'DISPATCH',authority:'SELLER'},'LIFECYCLE_AUTHORITY_DENIED');
...
{
  denied({domain:'PAYOUT',from:'SUBMITTED',to:'PAID',action:'MARK_PAID',authority:'OPERATOR',facts:{PROVIDER_EVENT_OR_PREVIEW:true}},'LIFECYCLE_AUTHORITY_DENIED');
...
{
  denied({domain:'PUBLICATION',from:'APPROVED',to:'PUBLISHED',action:'PUBLISH',authority:'SELLER',facts:{CHECKLIST_READY:true,CATALOGUE_APPROVED:true,TRUST_ALLOWED:true,SELLER_VERIFIED:true}},'LIFECYCLE_AUTHORITY_DENIED');
  denied({domain:'PUBLICATION',from:'APPROVED',to:'PUBLISHED',action:'PUBLISH',authority:'OPERATOR',facts:{CHECKLIST_READY:true,CATALOGUE_APPROVED:true}},'LIFECYCLE_PRECONDITION_FAILED');
  const x=ok({domain:'PUBLICATION',from:'APPROVED',to:'PUBLISHED',action:'PUBLISH',authority:'OPERATOR',facts:{CHECKLIST_READY:true,CATALOGUE_APPROVED:true,TRUST_ALLOWED:true,SELLER_VERIFIED:true}});
...
console.log('ANTIQUA lifecycle authority v16: 8 domains + authority + preconditions + terminal/negative contracts passed');

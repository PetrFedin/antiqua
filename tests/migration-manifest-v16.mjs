...
assert.equal(migrationManifest.length,16);
...
assert.equal(v14PlusMigrations.at(-1).version,'016_v17_object_engagement');
...
console.log('ANTIQUA v16 migration manifest: one ordered authority 001..016 with complete files passed');

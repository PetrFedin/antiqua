...
assert.equal(migrationManifest.length,17);
...
assert.equal(v14PlusMigrations.at(-1).version,'017_v20_offer_negotiation');
...
console.log('ANTIQUA v16 migration manifest: one ordered authority 001..017 with complete files passed');

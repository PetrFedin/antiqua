...
assert.equal(migrationManifest.length,15);
...
assert.equal(v14PlusMigrations.at(-1).version,'015_v16_db_integrity');
...
console.log('ANTIQUA v16 migration manifest: one ordered authority 001..015 with complete files passed');

...
assert.equal(v14PlusMigrations.at(-1).version,'017_v22_offer_negotiation');
...
console.log('ANTIQUA v22 migration manifest: one ordered authority 001..017 with complete files passed');

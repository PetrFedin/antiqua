...
assert.equal(migrationManifest.length,19);
...
assert.equal(v14PlusMigrations.at(-1).version,'019_v26_saved_search_alerts');
...
console.log('ANTIQUA v26 migration manifest: one ordered authority 001..019 with complete files passed');

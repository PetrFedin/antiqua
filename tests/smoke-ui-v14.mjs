...
try{
 ...
 const assets=['main.js','app.js','operations.js','modules/core.js','modules/discovery.js','modules/collection.js','modules/transactions.js','modules/cockpit.js','modules/culture-discovery.js','modules/object-desire.js','modules/taste-signals.js','modules/drops.js'];
 ...
 const css=await fetch(base+'/styles.css');assert.equal(css.status,200);assert.match(css.headers.get('content-type')||'',/text\/css/);const body=await css.text();assert.ok(body.length>90000);assert.match(body,/v14-operations/);assert.match(body,/v16-cockpit/);assert.match(body,/v0\.29 · Drops Engine/);
 console.log('ANTIQUA v29 UI smoke: canonical frontend graph assets passed');

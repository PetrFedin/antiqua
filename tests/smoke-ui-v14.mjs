...
try{
 ...
 const assets=['main.js','app.js','operations.js','modules/core.js','modules/discovery.js','modules/collection.js','modules/transactions.js','modules/cockpit.js','modules/culture-discovery.js','modules/object-desire.js','modules/taste-signals.js','modules/partner-drops.js','modules/creators.js'];
 ...
 console.log('ANTIQUA v30 UI smoke: canonical frontend graph assets passed');

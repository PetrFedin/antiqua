...
await migrateV10(db);
const ROOT=fileURLToPath(new URL('.',import.meta.url)),PUBLIC=join(ROOT,'public'),PORT=Number(process.env.PORT||10000),mime={'.html':'text/html; charset=utf-8','.css':'text/css; charset=utf-8','.js':'text/javascript; charset=utf-8','.json':'application/json; charset=utf-8','.svg':'image/svg+xml'};
